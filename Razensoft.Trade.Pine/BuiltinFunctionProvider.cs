...
namespace Razensoft.Trade.Pine
{
    public abstract class BuiltinFunctionProvider
    {
        ...
        public virtual bool input(
            object defval, object title, object type, object confirm)
        {
            throw new NotImplementedException();
        }
        /// <summary>
        ...
        public virtual int input(
            object defval, object title, object type, object minval, object maxval,
            object confirm, object step, object options)
        {
            throw new NotImplementedException();
        }
        /// <summary>
        ...
        public virtual string input(
            object defval, object title, object type, object confirm, object options)
        {
            throw new NotImplementedException();
        }
        /// <summary>
        ...
        /// indicators.
        /// </summary>
        public virtual PineSeries<float> input(object defval, object title, object type)
        {
            throw new NotImplementedException();
        }
        /// <summary>
