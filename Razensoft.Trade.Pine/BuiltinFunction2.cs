...
{
    public class BuiltinFunction2 : PineScriptFunction
    {
        private readonly MethodInfo _methodInfo;
        private readonly object _provider;

        public BuiltinFunction2(MethodInfo methodInfo, object provider) : base(methodInfo.Name)
        {
        ...
        public override bool CanAccept(object[] positionalArgs, Dictionary<string, object> namedArgs)
        {
            static bool IsAssignable(object arg, ParameterInfo parameterInfo)
            {
                ...
                return argType == parameterType || PineTypeSystem.IsConvertible(argType, parameterType);
            }
